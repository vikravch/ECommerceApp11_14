...
const CheckoutPage:React.FC = ()=> {
    ...
    return (<>{
        isLoading ? <Spinner/> :
            <div className="container p-0 mb-5" style={{minWidth: 320}}>
                            ...
                            <div className="rounded-2 border border-1 p-2">
                                ...
                                {cartItems.map((item) => (
                                    <div className="mb-3" key={item.product_id}>
                                        <div className="row flex-column flex-lg-row g-0 m-0">
                                            <div className="col col-lg-5 text-center text-lg-start">
                                                <img src="http://via.placeholder.com/105x127"
                                            ...
                                            <div className="col col-lg-7 text-center text-lg-start">
                                                <div className="card-body p-0">
                                                    <p className="my-0 small"><label
                                                        className="text-muted small my-0">#{item.product_id}</label></p>
                                                    <p className="my-0 small"><strong
                                                        className="card-title small my-0">{item.product_title}</strong>
                                                    </p>
                                                    <p className="my-0 small"><label
                                                        className="text-muted small my-0">Color: </label><label
                                                        className="mx-1 small my-0">{item.color}</label></p>
                                                    <p className="my-0 small"><label
                                                        className="text-muted small my-0">Size: </label><label
                        ...
                        <div className="col-12 col-sm-12 col-md-7 col-lg-8">
                            ...
                            <form className="needs-validation" noValidate onSubmit={handleCreateOrder}>
                                <div className="row g-3 m-0">
                                    <div className="col-12 col-lg-2 mt-5 mt-md-0 mt-lg-3">
                                        <h4 className="mb-0 mb-lg-2">Contacts</h4>
                                    </div>
                                    <div className="col-sm-10 d-none d-lg-block">
                                        <hr className="my-3"/>
                                    </div>
                                    ...
                                    <div className="col-12 col-lg-2 mt-5 mt-lg-3">
                                        <h4 className="mb-0 mb-lg-2">Address</h4>
                                    </div>
                                    <div className="col-sm-10 d-none d-lg-block">
                                        <hr className="my-3"/>
                                    </div>
                                    ...
                                    <div className="col-sm-6">
                                        ...
                                        <CountryDropdown value={country} onChange={(value) => setCountry(value)}
                                                         classes="form-select" id="country"/>
                                        <div className="invalid-feedback">
                                    ...
                                    <div className="col-sm-6">
                                        ...
                                        <label className="form-check-label mx-2"
                                               htmlFor="Standard">{shippings[0].title}</label>
                                    ...
                                    <div className="col-sm-6">
                                        ...
                                        <label className="form-check-label mx-2"
                                               htmlFor="Premium">{shippings[1].title}</label>
                                    ...
                                    <div className="col-12 col-lg-2 mt-5 mt-lg-3">
                                        <h4 className="mb-0 mb-lg-2">Payment</h4>
                                    </div>
                                    <div className="col-md-10 d-none d-lg-block">
                                        <hr className="my-3"/>
                                    </div>
                                </div>
                                <div className="my-3">
                                ...
                                <div className="row gy-3 mb-4">
                                    ...
                                    <div className="input-group w-75 mt-0">
                                        <input type="text" className="form-control w-50" id="cc-number"
