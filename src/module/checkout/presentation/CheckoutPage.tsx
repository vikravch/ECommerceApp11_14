                    ...
                    <form className="needs-validation" noValidate onSubmit={handleCreateOrder}>
                        <div className="row g-3 m-0">
                            ...
                            <div className="col-sm-6">
                                ...
                                <label className="form-check-label mx-2" htmlFor="Standard">{shippings[0].title}</label>
                            ...
                            <div className="col-sm-6">
                                ...
                                <label className="form-check-label mx-2" htmlFor="Premium">{shippings[1].title}</label>
